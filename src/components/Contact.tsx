...
const contactTypes = [
  "บริการให้คำปรึกษาเพื่อพัฒนาผลิตภัณฑ์ และ การขอเลข อย. (IDEA SERVICES)",
  "บริการด้านการฝึกอบรมด้านเทคโนโลยีการผลิตและนวัตกรรม (IDEA TRAINNING)",
  "บริการด้านวิจัยและพัฒนานวัตกรรมผลิตภัณฑ์อาหารในระดับห้องปฏิบัติการ (IDEA R&D)",
  "บริการด้านสายการผลิตและเครื่องมือแปรรูป (IDEA PILOT PLANT)",
  "บริการด้านการตรวจวิเคราะห์ หรือ ทดสอบคุณภาพทางด้านเคมีกายภาพ (IDEA FOOD LAB)",
  "บริการเครื่องมือ/อุปกรณ์/ครัวทดลอง (IDEA MARKER SPACE)",
  "บริการพื้นที่ และห้องปฏิบัติการ (IDEA ROOM)",
];
          ...
          <div className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-gray-100">
            ...
            {sent ? (
              <div className="rounded-xl bg-green-50 p-6 text-center ring-1 ring-green-200">
                <p className="font-semibold text-green-600">ส่งข้อมูลเรียบร้อยแล้ว</p>
