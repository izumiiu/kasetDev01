    ...
    <footer id="contact" className="border-t-4 border-orange-500 bg-gray-800 text-gray-100">
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          {/* Social */}
          <div>
            <h3 className="mb-3 text-base font-semibold text-white">ติดตามเรา</h3>
            <div className="flex gap-3">
              ...
              <a href="#" aria-label="Instagram" className="rounded-full bg-gray-700 p-2 transition-colors hover:bg-green-500">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="#" aria-label="Youtube" className="rounded-full bg-gray-700 p-2 transition-colors hover:bg-green-500">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
